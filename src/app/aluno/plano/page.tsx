...
export default async function PlanoPage({ searchParams }: Props) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">Plano de estudo</h1>
        ...
        {blocks.length === 0 ? (
          ...
          <ul className="mt-3 space-y-2">
            {blocks.map((b) => (
              <li
                key={b.id}
                className="flex flex-col justify-between gap-2 rounded-lg border border-slate-100 bg-white px-4 py-3 sm:flex-row sm:items-center"
              >
                <div>
